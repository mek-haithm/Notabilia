...
class AddNoteForFolderScreen extends StatefulWidget {
  final int folderId;
  final String folderName;
  const AddNoteForFolderScreen({
    super.key,
  ...
  @override
  State<AddNoteForFolderScreen> createState() => _AddNoteForFolderScreenState();
}

class _AddNoteForFolderScreenState extends State<AddNoteForFolderScreen> {
