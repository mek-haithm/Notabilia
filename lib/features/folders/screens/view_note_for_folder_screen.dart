...
class ViewNoteForFolderScreen extends StatefulWidget {
  final int folderId;
  final String folderName;
  final Note note;
  const ViewNoteForFolderScreen({
    super.key,
    required this.note,
  ...
  @override
  State<ViewNoteForFolderScreen> createState() =>
      _ViewNoteForFolderScreenState();
}

class _ViewNoteForFolderScreenState extends State<ViewNoteForFolderScreen> {
              ...
              if (value == "setPassword".tr) {
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                ...
                                if (isArabic(content)) {
                                  content = content.split('').reversed.join('');
                                }
                                ...
                                if (directoryPath != null) {
                                  File file = File('$directoryPath/$title.txt');
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'textFile'.tr,
                                      style: kSelectedLabelStyle(context),
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            InkWell(
                              onTap: () async {
                                ...
                                String? directoryPath = await FilePicker
                                    ...
                                    .getDirectoryPath();
                                if (directoryPath != null) {
                                  File file = File('$directoryPath/$title.pdf');
                ...
                MyMessage.showMyMessage(
                  ...
                  onSecondButtonPressed: () async {
                    int id = await _databaseHelper.moveNoteToTrash(widget.note.id!);
                    if (id == -1) {
                      MySnackBar.showSnackBar(
            ...
            children: [
              ...
              MyButton(
                ...
                onPressed: () async {
                  ...
                  int id =
                      await _databaseHelper.updateNote(widget.note.id!, note);
                  if (id == -1) {
                    MySnackBar.showSnackBar(
                      message: 'somethingWrongHappened'.tr,
                    );
